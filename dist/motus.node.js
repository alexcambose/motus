...
/* harmony import */ var _helpers_throwError_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./helpers/throwError.js */ "./src/helpers/throwError.js");
/* harmony import */ var _enum_errorEnum__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./enum/errorEnum */ "./src/enum/errorEnum.js");
/* harmony import */ var _enum_specialUnitEnum__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./enum/specialUnitEnum */ "./src/enum/specialUnitEnum.js");
...
function () {
  function Motus() {
    ...
    this._animations = [];
    this.NO_UNIT = _enum_specialUnitEnum__WEBPACK_IMPORTED_MODULE_6__["NO_UNIT"];
    this.COLOR_UNIT = _enum_specialUnitEnum__WEBPACK_IMPORTED_MODULE_6__["COLOR_UNIT"];
  }
  /** Adds an animation
   * @example
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(Motus, [{
    ...
    value: function addAnimation(animation) {
      ...
      if (animation instanceof this.Animation) {
        ...
        Object(_helpers_throwError_js__WEBPACK_IMPORTED_MODULE_4__["default"])(_enum_errorEnum__WEBPACK_IMPORTED_MODULE_5__["ANIMATION_NOT_INSTANCE_OF_ANIMATION"]);
      }
    }
    /**
    ...
    key: "clearAnimation",
    value: function clearAnimation(animation) {
      var autostop = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;
      // check if animation parameter is a valid animation
      if (!(animation instanceof this.Animation)) Object(_helpers_throwError_js__WEBPACK_IMPORTED_MODULE_4__["default"])(_enum_errorEnum__WEBPACK_IMPORTED_MODULE_5__["ANIMATION_NOT_INSTANCE_OF_ANIMATION"]);

      var foundAnimationIndex = this._animations.findIndex(function (e) {
        return animation.getUid() === e.getUid();
      }); // if there is no found animation


      if (foundAnimationIndex === -1) Object(_helpers_throwError_js__WEBPACK_IMPORTED_MODULE_4__["default"])(_enum_errorEnum__WEBPACK_IMPORTED_MODULE_5__["NO_ANIMATION_FOUND"]);
...
function () {
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(Point, null, [{
    ...
    value: function getPxFromPoint(point, $scrollElement, horizontal) {
      ...
      var containerOffset = Object(_helpers_dom__WEBPACK_IMPORTED_MODULE_3__["getOffset"])($scrollElement, horizontal) || 0; // window offset is undefined

      var offset = Object(_helpers_dom__WEBPACK_IMPORTED_MODULE_3__["getOffset"])(point, horizontal) - containerOffset;
    ...
    value: function getDistanceFromParent($el, $parent, horizontal) {
      var parentOffset = $parent === window ? 0 : Object(_helpers_dom__WEBPACK_IMPORTED_MODULE_3__["getOffset"])($parent, horizontal);
      var elementOffset = Object(_helpers_dom__WEBPACK_IMPORTED_MODULE_3__["getOffset"])($el, horizontal);
...
/* harmony import */ var _helpers_throwError_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../helpers/throwError.js */ "./src/helpers/throwError.js");
...
function () {
  ...
  function Animation(options) {
    ...
    this.uid = Object(_helpers___WEBPACK_IMPORTED_MODULE_8__["uniqid"])();
    ...
    if (!Object(_helpers___WEBPACK_IMPORTED_MODULE_8__["isHtmlElement"])(this.$el)) {
      Object(_helpers_throwError_js__WEBPACK_IMPORTED_MODULE_9__["default"])(_enum_errorEnum__WEBPACK_IMPORTED_MODULE_10__["VALUE_IS_NOT_HTML_ELEMENT"], this.$el);
    } // normalized keyframes


    this.keyframes = _Keyframes__WEBPACK_IMPORTED_MODULE_4__["default"].normalize(this.options.keyframes, this.options.$el); // set the default started value

    this.started = this.options.started; // default options
    // variables that are true if the scroll is before or after the animation start and end points

    this.appliedAllBefore = false;
    this.appliedAllAfter = false; // animator used to apply keyframes to the $el based on percent

    this._animator = new _animation_Animator__WEBPACK_IMPORTED_MODULE_6__["default"](this.keyframes, this.options.$el); // throttle the method that will be called on scroll

    this._compute = lodash_throttle__WEBPACK_IMPORTED_MODULE_7___default()(this.__compute, this.options.throttle); // throttle the method that will be called on on resize to update start and end point
    ...
    window.addEventListener('resize', function () {
      return handleResize(_this.options.startPoint, _this.options.endPoint);
    });
  }
  /**
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_2___default()(Animation, [{
    ...
    value: function start() {
      ...
      if (started) return; // add event listener if not started
    ...
    value: function stop() {
      ...
      if (!started) return; // remove event listener if started
    ...
    value: function _computePositions(startPoint, endPoint) {
      ...
      if (Object(_helpers___WEBPACK_IMPORTED_MODULE_8__["isSet"])(startPoint) && !Object(_helpers___WEBPACK_IMPORTED_MODULE_8__["isArray"])(startPoint)) {
        ...
        this.startPoint = _Point__WEBPACK_IMPORTED_MODULE_5__["default"].getDistanceFromParent(this.$el, $scrollElement, horizontal) - Object(_helpers___WEBPACK_IMPORTED_MODULE_8__["getElementDimensions"])($scrollElement)[horizontal ? 'width' : 'height'];
        if (Object(_helpers___WEBPACK_IMPORTED_MODULE_8__["isArray"])(startPoint)) this.startPoint += startPoint[0];
      }

      if (Object(_helpers___WEBPACK_IMPORTED_MODULE_8__["isSet"])(endPoint) && !Object(_helpers___WEBPACK_IMPORTED_MODULE_8__["isArray"])(endPoint)) {
        // end point
        this.endPoint = _Point__WEBPACK_IMPORTED_MODULE_5__["default"].getPxFromPoint(endPoint, $scrollElement, horizontal);
      } else {
        // if point is not defined get the distance to it
        this.endPoint = _Point__WEBPACK_IMPORTED_MODULE_5__["default"].getDistanceFromParent(this.$el, $scrollElement, horizontal) + Object(_helpers___WEBPACK_IMPORTED_MODULE_8__["getElementDimensions"])(this.$el)[horizontal ? 'width' : 'height'];
        if (Object(_helpers___WEBPACK_IMPORTED_MODULE_8__["isArray"])(endPoint)) this.endPoint += endPoint[0];
      }
    }
    /**
    ...
    value: function __compute() {
      ...
      var scroll = this._getScrollPosition(); // call scroll animation hook
...
function () {
  function Animator(keyframes, $el) {
    ...
    this.elementStyles = new _Styler__WEBPACK_IMPORTED_MODULE_6__["default"]($el);
  }
  /**
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_3___default()(Animator, [{
    ...
    value: function _applyKeyframe(keyframe, percent) {
      ...
      Object.keys(keyframe).forEach(function (property) {
        ...
        } else if (Object(_helpers___WEBPACK_IMPORTED_MODULE_5__["isArray"])(from) && Object(_helpers___WEBPACK_IMPORTED_MODULE_5__["isArray"])(to)) {
          _this3._applyArrayValues(property, from, to, percent);
        } else {
          Object(_helpers_throwError_js__WEBPACK_IMPORTED_MODULE_9__["default"])(_enum_errorEnum__WEBPACK_IMPORTED_MODULE_10__["UNEXPECTED_ERROR"]);
        }
      });
    }
    /**
...
/* harmony import */ var _helpers___WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../helpers/ */ "./src/helpers/index.js");
/* harmony import */ var _helpers_throwError_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../helpers/throwError.js */ "./src/helpers/throwError.js");
...
function () {
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_4___default()(Keyframes, null, [{
     ...
     */
    value: function normalize(keyframes, $el) {
      var _this = this;
      ...
      if (!Object.keys(keyframes).length) Object(_helpers_throwError_js__WEBPACK_IMPORTED_MODULE_6__["default"])(_enum_errorEnum__WEBPACK_IMPORTED_MODULE_7__["NO_KEYFRAMES"]); // loop through each keyframe values
      ...
      Object.keys(keyframes).forEach(function (keyframePercent) {
        ...
        if (!Object(_helpers___WEBPACK_IMPORTED_MODULE_5__["isNumeric"])(keyframePercent)) {
          Object(_helpers_throwError_js__WEBPACK_IMPORTED_MODULE_6__["default"])(_enum_errorEnum__WEBPACK_IMPORTED_MODULE_7__["INVALID_KEYFRAME_PERCENT"], keyframePercent);
        ...
        Object.keys(keyframe).forEach(function (keyframeProperty) {
          ...
          var normalizedValue = _this._normalizeKeyframeRule(keyframeProperty, keyframePercent, keyframes, $el); // rewrite the current property and keep the old ones to be normalized
    ...
    value: function _normalizeKeyframeRule(property, keyframePercent, keyframes, $el) {
      var from, to, unit;
      var value = keyframes[keyframePercent][property]; // {height: value}, value must be defined

      if (!Object(_helpers___WEBPACK_IMPORTED_MODULE_5__["isSet"])(value)) Object(_helpers_throwError_js__WEBPACK_IMPORTED_MODULE_6__["default"])(_enum_errorEnum__WEBPACK_IMPORTED_MODULE_7__["KEYFRAMES_VALUE_NOT_SPECIFIED"]); // if the provided value is a number, we need to set `from` and `unit`

      if (Object(_helpers___WEBPACK_IMPORTED_MODULE_5__["isNumber"])(value)) {
        var _this$_normalizeNumbe = this._normalizeNumberValue(property, keyframePercent, keyframes, $el);
        ...
        var _this$_normalizeStrin = this._normalizeStringValue(property, keyframePercent, keyframes, $el);
        ...
        var previousKeyframe = this._previousKeyframeProperty(property, keyframePercent, keyframes, $el);
        ...
        var _this$_normalizeObjec = this._normalizeObjectValue(property, keyframePercent, keyframes, $el);
        ...
        Object(_helpers_throwError_js__WEBPACK_IMPORTED_MODULE_6__["default"])(_enum_errorEnum__WEBPACK_IMPORTED_MODULE_7__["UNKNOWN_PROPERTY_VALUE"], property);
      }
    ...
    value: function _previousKeyframeProperty(property, currentPercent, keyframes, $el) {
      ...
      if (previousKeyframePercent === false) {
        ...
        return Object(_helpers___WEBPACK_IMPORTED_MODULE_5__["getValue"])(Object(_helpers___WEBPACK_IMPORTED_MODULE_5__["getElementDefaultProperty"])($el, property));
      ...
      if (propertyValue) {
        ...
        return this._previousKeyframeProperty(property, previousKeyframePercent, keyframes, $el);
      }
    }
    /**
    ...
    value: function _normalizeNumberValue(property, currentKeyframePercent, keyframes, $el) {
      var value = keyframes[currentKeyframePercent][property];

      var _this$_previousKeyfra = this._previousKeyframeProperty(property, currentKeyframePercent, keyframes, $el),
    ...
    value: function _normalizeStringValue(property, currentKeyframePercent, keyframes, $el) {
      var value = keyframes[currentKeyframePercent][property];
      ...
      var _this$_previousKeyfra3 = this._previousKeyframeProperty(property, currentKeyframePercent, keyframes, $el),
      ...
      if (previousUnit !== unit) {
        Object(_helpers_throwError_js__WEBPACK_IMPORTED_MODULE_6__["default"])(_enum_errorEnum__WEBPACK_IMPORTED_MODULE_7__["PREVIOUS_UNIT_DOES_NOT_MATCH_CURRENT"], previousUnit, unit);
      }
    ...
    value: function _normalizeObjectValue(property, currentKeyframePercent, keyframes, $el) {
      ...
      var _keyframes$currentKey = keyframes[currentKeyframePercent][property],
          ...
          unit = _keyframes$currentKey.unit; // const [fromValue, fromUnit]

      var _this$_previousKeyfra5 = this._previousKeyframeProperty(property, currentKeyframePercent, keyframes, $el),
          ...
          previousUnit = _this$_previousKeyfra6[1]; // throw error if `to` is not defined


      if (!Object(_helpers___WEBPACK_IMPORTED_MODULE_5__["isSet"])(to)) {
        Object(_helpers_throwError_js__WEBPACK_IMPORTED_MODULE_6__["default"])(_enum_errorEnum__WEBPACK_IMPORTED_MODULE_7__["KEYFRAME_TO_IS_NOT_SET"]);
      } // if `from` is not specified, inherit it from the previous keyframe from


      var _ref = Object(_helpers___WEBPACK_IMPORTED_MODULE_5__["isSet"])(from) ? Object(_helpers___WEBPACK_IMPORTED_MODULE_5__["getValue"])(from) : [previousFrom, previousUnit],
          _ref2 = _babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_0___default()(_ref, 2),
          fromValue = _ref2[0],
          fromUnit = _ref2[1];

      var _getValue3 = Object(_helpers___WEBPACK_IMPORTED_MODULE_5__["getValue"])(to),
          _getValue4 = _babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_0___default()(_getValue3, 2),
          toValue = _getValue4[0],
          toUnit = _getValue4[1]; // check `from` and `to` units only if unit is not set


      if (!unit) {
        // throw error if the to and from units are different
        if (fromUnit !== toUnit) {
          Object(_helpers_throwError_js__WEBPACK_IMPORTED_MODULE_6__["default"])(_enum_errorEnum__WEBPACK_IMPORTED_MODULE_7__["TO_UNIT_DOES_NOT_MATCH_FROM"], toUnit, fromUnit);
        }
...
function () {
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(Styler, [{
    ...
    value: function apply(name, value, unit) {
      ...
      if (_enum_functionValuesEnum__WEBPACK_IMPORTED_MODULE_3__["default"][name]) this._applyArray(name, [value + unit]);
    ...
    value: function _applyArray(name, value) {
      var functionName = _enum_functionValuesEnum__WEBPACK_IMPORTED_MODULE_3__["default"][name].functionName; // if value is an array of arrays convert it into an array of arguments string

      value = value.map(function (e) {
        if (Object(_helpers___WEBPACK_IMPORTED_MODULE_2__["isArray"])(e)) {
          if (e[1] === _enum_specialUnitEnum__WEBPACK_IMPORTED_MODULE_5__["NO_UNIT"]) return e[0];
          return e[0] + e[1];
        }

        return e;
      });
      css_func__WEBPACK_IMPORTED_MODULE_4___default()(this.$el, functionName).add(name, value);
    }
  }]);
...
/*!*******************************!*\
  !*** ./src/enum/errorEnum.js ***!
  \*******************************/
/*! exports provided: UNKNOWN_PROPERTY_VALUE, KEYFRAMES_VALUE_NOT_SPECIFIED, INVALID_KEYFRAME_PERCENT, NO_VALUE_SPECIFIED, PREVIOUS_UNIT_DOES_NOT_MATCH_CURRENT, TO_UNIT_DOES_NOT_MATCH_FROM, KEYFRAME_TO_IS_NOT_SET, ANIMATION_NOT_INSTANCE_OF_ANIMATION, NO_KEYFRAMES, UNEXPECTED_ERROR, VALUE_IS_NOT_HTML_ELEMENT, NO_ANIMATION_FOUND */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TO_UNIT_DOES_NOT_MATCH_FROM", function() { return TO_UNIT_DOES_NOT_MATCH_FROM; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "NO_ANIMATION_FOUND", function() { return NO_ANIMATION_FOUND; });
...
var TO_UNIT_DOES_NOT_MATCH_FROM = function TO_UNIT_DOES_NOT_MATCH_FROM(toUnit, fromUnit) {
  return "'to' unit ('".concat(toUnit, "') does not match 'from' unit ('").concat(fromUnit, "')");
...
var NO_ANIMATION_FOUND = function NO_ANIMATION_FOUND() {
...
Object.keys(filters).forEach(function (prop) {
  return filters[prop] = _babel_runtime_helpers_objectSpread__WEBPACK_IMPORTED_MODULE_0___default()({}, filters[prop], {
    functionName: 'filter'
  });
});
/* harmony default export */ __webpack_exports__["default"] = (_babel_runtime_helpers_objectSpread__WEBPACK_IMPORTED_MODULE_0___default()({}, transforms, filters));
...
/* harmony import */ var _helpers_throwError_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../helpers/throwError.js */ "./src/helpers/throwError.js");
...
var getElementDimensions = function getElementDimensions($el) {
  if ($el === window) {
    return {
...
var getElementScroll = function getElementScroll($el) {
...
var getValue = function getValue(value) {
  ...
  if (match && match.length === 3) {
    var _value = parseFloat(match[1]);

    var unit = match[2] || _enum_specialUnitEnum__WEBPACK_IMPORTED_MODULE_1__["NO_UNIT"];
    return [_value, unit];
  }

  Object(_helpers_throwError_js__WEBPACK_IMPORTED_MODULE_3__["default"])(_enum_errorEnum__WEBPACK_IMPORTED_MODULE_2__["NO_VALUE_SPECIFIED"]);
};
var getElementDefaultProperty = function getElementDefaultProperty($el, property) {
  ...
  return _window.getComputedStyle($el, null).getPropertyValue(Object(___WEBPACK_IMPORTED_MODULE_5__["camelToKebabCase"])(property));
};
...
/*!******************************!*\
  !*** ./src/helpers/index.js ***!
  \******************************/
/*! exports provided: previousArrayValue, calculatePercent, floorWithPrecision, calculateValueFromPercent, uniqid, getElementDimensions, getElementScroll, getValue, getElementDefaultProperty, createFunctionString, camelToKebabCase, isNumber, isString, isObject, isArray, isNumeric, isHtmlElement, isSet, throwError */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "uniqid", function() { return _math_js__WEBPACK_IMPORTED_MODULE_0__["uniqid"]; });
...
/* harmony import */ var _throwError__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./throwError */ "./src/helpers/throwError.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "throwError", function() { return _throwError__WEBPACK_IMPORTED_MODULE_5__["default"]; });
...
/*!*****************************!*\
  !*** ./src/helpers/math.js ***!
  \*****************************/
/*! exports provided: previousArrayValue, calculatePercent, floorWithPrecision, calculateValueFromPercent, uniqid */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/******/ });
//# sourceMappingURL=motus.node.js.map